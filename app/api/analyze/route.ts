  ...
  try {
    ...
    const response = await ai.models.generateContent({
      ...
      contents: [
        ...
        [게이지(gauge) 규칙]:
        - '코', '단', 'sts', 'rows' 같은 문자는 무조건 제외하고 "오직 숫자와 곱하기(*) 기호"만 넣으세요. 숫자와 기호 사이에 공백(띄어쓰기)은 절대 넣지 마세요.
        - 게이지 정보가 도안에서 전혀 발견되지 않거나 비어있다면, 무조건 숫자 '0' 하나만 적으세요.

        [종류(type) 규칙]:
        - 의류의 종류는 영어(예: pullover, cardigan)를 절대 사용하지 말고, 100% 한글로만 번역해서 대답하세요. (예: 풀오버, 가디건, 조끼)

        [영어 도안 판별 및 특징(note) 규칙 - 필수 🌟]:
        - 분석 중인 도안이 '영어'로 작성된 도안(영어 서술형 도안, 영문 차트 등)인지 확인하세요.
        - 만약 영어 도안인 경우, 'note' 칸의 가장 첫머리에 반드시 [영어] 혹은 "영어" 단어를 포함하여 요약해 주세요. (예: "영어, 4mm 바늘 사용, 탑다운 구조")
        - 한국어 도안이라면 평소처럼 바늘 정보 및 특이사항만 요약해 주면 됩니다.
